    ...
    return ( 
        <>
            ...
            <div className="bg-white w-3/4 h-160 rounded-xl mx-auto overflow-hidden">
                ...
                <h2 className="text-white hover:text-shadow-xl text-center sm:text-xl md:text-6xl my-17">What you'll get</h2>
            <div className="flex justify-around">
               ...
               <div className="bg-white w-90 h-70 items-center flex flex-col px-3 py-4 rounded-3xl shadow-lg hover:shadow-2xl hover:scale-110 transition-transform duration-500 ease-in-out">
                ...
                <hr className="border-gray-700 w-8/9 mx-auto border-t my-10"/>
            ...
            <div className="flex justify-center items-center gap-25">
              <div className="flex flex-col bg-white text-center rounded-2xl w-[600px] h-[440px] hover:shadow-2xl justify-cente">
                 <h2 className="text-green-800 text-5xl py-4 font-bold my-10 text-left mx-5">Built for real life</h2>
                 <p className="text-green-700 font-bold leading-7 text-base px-1.5 py-1">We have hundreds of tasty recipes from quick snacks to full family dinners <br />so you'll never run out of ideas. Whether you're a beginner or a seasoned cook,<br /> we've got step-by-step guides to help you turn simple ingredients into mouth-watering meals.</p>  
              </div> 
              <div className="flex w-[600px] h-[440px] rounded-xl overflow-hidden object-cover">
